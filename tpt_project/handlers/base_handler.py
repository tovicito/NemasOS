...
class BaseHandler(ABC):
    ...
    def install(self) -> dict:
        """
        Prepara un diccionario base con detalles de la instalación.
        Las subclases deben llamar a este método y extender el diccionario devuelto.
        """
        return {
            "handler": self.__class__.__name__,
            "clone_path": self.package_info.get("clone_path"),
            "source": self.package_info.get("source"),
        }
