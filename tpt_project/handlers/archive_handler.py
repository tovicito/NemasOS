...
class ArchiveHandler(BaseHandler):
    ...
    def __init__(self, package_info: dict, config: Configuracion, logger: Logger, temp_path: Path):
    ...
    def install(self) -> dict:
        ...
        try:
            ...
            execute_command([
                "tar", "-xzf", str(self.temp_path), "-C", str(extract_dir),
                f"--strip-components={strip_components}"
            ], self.logger, as_root=True)
