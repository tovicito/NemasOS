...
class SetupWindow(Adw.ApplicationWindow):
    ...
    def _on_finish(self, button):
        ...
        # 1. Guardar idioma y compilar .mo
        ...
        # La ruta a locale debe ser relativa al proyecto
        ...
        if po_file.exists():
            ...
            print(f"Advertencia: No se encontró el archivo {po_file} para compilar.")

        # 2. Guardar repositorios
